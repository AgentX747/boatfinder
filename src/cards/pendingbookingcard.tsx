                ...
                <div className="flex-1 p-4 md:p-6 flex flex-col gap-3">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                            ...
                            <div className="flex flex-col sm:flex-col gap-2 sm:gap-3 flex-shrink-0">
                                <div className="flex flex-col items-start sm:items-center gap-1">
                                    ...
                                    <span className="bg-yellow-100 text-yellow-700 border border-yellow-300 px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wide w-full sm:w-28 text-center">
                                        Pending
                                    </span>
                                </div>
                                <div className="flex flex-col items-start sm:items-center gap-1">
                    ...
                    <div className="flex flex-col gap-3 pt-3 border-t border-blue-100">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 w-full">
                            <button
                                className="bg-blue-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors uppercase tracking-wide text-sm flex-1 sm:flex-none"
                                onClick={navigateTo}
                            >
                                View Details
                            </button>
                            <button
                                className="bg-red-500 text-white px-4 py-2 rounded-lg font-medium hover:bg-red-600 transition-colors uppercase tracking-wide text-sm flex-1 sm:flex-none"
