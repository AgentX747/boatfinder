      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-6">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
            <div>
              <h3 className="text-xl font-bold text-blue-900 mb-2">{boatName}</h3>
            ...
            <div className="flex flex-col gap-3 items-center">
              <div className="flex flex-col items-center gap-1">
                ...
                <span className="bg-green-100 text-green-700 border border-green-300 px-4 py-1 rounded-full text-xs font-semibold uppercase tracking-wide w-28 text-center">
                  Accepted
                </span>
              </div>
              <div className="flex flex-col items-center gap-1">
