  ...
  return (
    <div className="bg-white rounded-xl shadow-md border border-blue-100 overflow-hidden hover:shadow-lg transition-shadow w-full">
      <div className="flex flex-col md:flex-row">
        ...
        {/* Image / Icon Section */}
        <div className="w-full md:w-56 h-40 md:h-auto bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center flex-shrink-0">
          <svg className="w-16 h-16 md:w-20 md:h-20 text-white opacity-40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex-1 p-4 md:p-6 flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
              <div className="min-w-0">
                <h3 className="text-lg md:text-xl font-bold text-blue-900 uppercase tracking-wide truncate">
                  {boatName}
                </h3>

                {/* IDs clearly labeled - Responsive */}
                <div className="flex flex-col sm:flex-row sm:flex-wrap gap-2 sm:gap-4 mt-1">
          ...
          {/* ── Row 2: Date & Time Details - Mobile Optimized ── */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 py-2">
            ...
            <div className="flex items-start gap-2 text-blue-700">
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm font-medium text-blue-900 truncate">{bookDate}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2 text-blue-700">
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm font-medium text-blue-900 uppercase truncate">{schedules?.departureTime ?? '—'}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2 text-blue-700">
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm font-medium text-blue-900 uppercase truncate">{schedules?.arrivalTime ?? '—'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-3 border-t border-blue-100">
            <div className="min-w-0">
              ...
              <p className="text-xl md:text-2xl font-bold text-blue-900">₱{bookPrice.toLocaleString()}</p>
            </div>
          </div>
